...
<x-app-layout>
    ...
    <div class="py-6 max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 space-y-4">
        <a href="{{ route('tickets.index') }}" class="text-sm text-blue-500 hover:underline">Tiket Saya</a>
        ...
        @if($errors->any())
        <div class="bg-red-50 border border-red-200 text-red-600 text-sm px-4 py-3">
            {{ $errors->first() }}
        </div>
        @endif
        ...
        <div class="bg-white border border-gray-100 p-5 space-y-3">
            <div class="flex items-start justify-between gap-2">
                ...
                <div class="flex gap-1.5">
                    ...
                    <span class="px-2 py-0.5 text-xs font-medium bg-red-100 text-red-600">Urgent</span>
                    @endif
        ...
        <div class="space-y-3">
            ...
            <div class="flex flex-col items-end">
                <div class="max-w-[85%] bg-blue-600 text-white px-4 py-3">
                    <p class="text-xs font-semibold mb-1 text-blue-200">{{ $ticket->user_name }} (Anda)</p>
