...
<x-app-layout>
    ...
    <div class="py-6 max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 space-y-4">
        <a href="{{ route('bookings.show', $booking->_id) }}"
           class="text-sm text-blue-500 hover:underline">Kembali ke Pesanan</a>

        {{-- Info pesanan --}}
        <div class="bg-blue-50 border border-blue-100 px-4 py-3 flex gap-3 items-center">
        ...
        <div class="bg-white border border-gray-100 p-6">
            ...
            @if($errors->any())
            <div class="bg-red-50 border border-red-200 text-red-600 text-sm px-4 py-3 mb-4">
                {{ $errors->first() }}
            </div>
            @endif
