...
<x-app-layout>
    ...
    <div class="py-6 max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 space-y-4">
        <a href="{{ route('driver.bookings.index') }}" class="text-sm text-blue-500 hover:underline">Pesanan Saya</a>
        ...
        @if($booking->status === 'confirmed')
            @if($canPickup)
            <div class="bg-blue-50 border border-blue-200 p-4 space-y-3">
                <div class="flex items-start gap-3">
                    <div class="h-8 w-8 bg-blue-100 flex items-center justify-center shrink-0">
                    ...
                    <div>
                        <p class="text-sm font-semibold text-blue-800">Waktunya menjemput!</p>
                ...
                <form method="POST" action="{{ route('driver.bookings.pickup', $booking->_id) }}"
                    ...
                    @csrf
                    <button type="submit"
                            class="w-full py-3 bg-blue-600 text-white text-sm font-semibold hover:bg-blue-700 active:scale-95 transition">
            ...
            <div class="bg-blue-50 border border-blue-200 p-4 flex items-start gap-3">
        ...
        <div class="bg-green-50 border border-green-200 p-4 flex items-center gap-3">
            <div class="h-2.5 w-2.5 bg-green-500 animate-pulse shrink-0"></div>
            <p class="text-sm font-semibold text-green-700">Perjalanan sedang berjalan</p>
        </div>
        @endif

        @if($booking->status === 'completed')
        <div class="bg-gray-50 border border-gray-200 p-4 flex items-center gap-3">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div class="bg-white border border-gray-100 p-5 space-y-2">
                ...
                <div class="text-sm space-y-1.5">
                    ...
                    <div class="flex justify-between">
                        ...
                        <a href="tel:{{ $booking->user['phone'] ?? '' }}" class="text-blue-500">
            ...
            <div class="bg-white border border-gray-100 p-5 col-span-full space-y-2">
                <h4 class="font-semibold text-gray-700 border-b pb-2">Rute</h4>
                <div class="text-sm space-y-2">
                    <div class="flex items-start gap-2">
                        <span class="h-5 w-5 bg-green-100 text-green-600 text-xs flex items-center justify-center shrink-0 mt-0.5">A</span>
                        <div>
                    ...
                    @if($booking->dropoff)
                    <div class="flex items-start gap-2">
                        <span class="h-5 w-5 bg-red-100 text-red-600 text-xs flex items-center justify-center shrink-0 mt-0.5">B</span>
                        <div>
                    ...
                    @endif
                    @if($booking->notes)
                    <p class="text-xs text-gray-400 bg-gray-50 px-3 py-2">📝 {{ $booking->notes }}</p>
                    @endif
                </div>
            </div>
        </div>
